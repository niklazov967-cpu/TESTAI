...
КРИТИЧЕСКИ ВАЖНО - СТРОГО ЗАПРЕЩЕНО:
❌ ЗАПРЕЩЕНО копировать механические свойства между аналогами!
❌ ЗАПРЕЩЕНО использовать одинаковые значения для USA, Russia и China!
❌ Если для аналога нет данных - укажи null, НЕ КОПИРУЙ из другого аналога!

ОБЯЗАТЕЛЬНО:
✅ Для КАЖДОГО аналога ищи ОТДЕЛЬНЫЕ механические свойства в источниках
✅ USA (904L), Russia, China - ЭТО РАЗНЫЕ СТАЛИ с РАЗНЫМИ свойствами!
✅ Используй ТОЛЬКО реальные данные из источников для КОНКРЕТНОГО аналога
✅ Если данных нет в источниках - укажи null (не копируй, не придумывай)

⚠️ ПРОВЕРКА ПЕРЕД ОТВЕТОМ:
1. Сравни yield_strength, tensile_strength, elongation для USA, Russia, China
2. Если ВСЕ ТРИ ИДЕНТИЧНЫ - это КРИТИЧЕСКАЯ ОШИБКА!
3. Найди уникальные данные для каждого аналога или укажи null
4. Каждый аналог должен иметь СВОИ уникальные механические свойства
